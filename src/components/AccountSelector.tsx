...
import { AccountType, Account, AddonContext } from "@wealthfolio/addon-sdk";
import {
  Icons,
  Skeleton,
  Button,
...
import { PORTFOLIO_ACCOUNT_ID } from "../lib";
...
>(
  (
    ...
    if (includePortfolio) {
      ...
      const portfolioExists = accounts.some(
        (account) => account.id === PORTFOLIO_ACCOUNT_ID
      );
    ...
    const renderSkeleton = () => {
      switch (variant) {
        case "card":
          return (
            <div className="h-full w-full rounded-lg border border-dashed border-border bg-background/50 p-2">
            ...
            <Button
              ...
              className={`h-full w-full justify-center rounded-lg border border-dashed p-2 transition-colors ${
                open
                  ...
                  : "border-border bg-background/50 hover:border-muted-foreground/50 hover:bg-background/80"
              }`}
            >
              <div className="flex flex-col items-center justify-center space-y-1">
                  ...
                  {selectedAccount ? (
                    ...
                    >
                      ...
                      >
                        {(() => {
                          const IconComponent =
                            accountTypeIcons[selectedAccount.accountType] ||
                            Icons.CreditCard;
                          return (
